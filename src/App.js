      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        <div className="form-container">
          <div className="flex items-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center h-full">
                <h1 className="text-white text-2x1">The Best Weather Forecast App</h1>
        ...
        <div className='w-2/4 p-5'>
            ...
            <div className='flex flex-col my-10'>
                ...
                <div className='container p-4 flex items-center justify-center h-1/3 mb-auto'></div>  :
                <>
                  <h1 className='text-5x1 text-gray-800 mt-auto mb-4'>
                  <DetailCard weather_icon={weatherIcon} data={weatherData} />Today
                  </h1>
                  <h2 className='text-3x1 text-gray-600 mb-4 mt-10'>More on {city}</h2>
